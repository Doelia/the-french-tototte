...
export default function Spotify() {
    ...
    return (
        <div className={"bg-gradient-to-b from-bg2 via-bg3 to-bg2"}>
            <div className="group relative container mx-auto max-w-xl pt-20 px-5">
                ...
                <div className={"flex flex-col md:flex-row gap-10"}>
                    <div className={"md:w-1/2 text-5xl text-fg1  " + tartuffo.className}>sucotez vos titres preferes</div>
